...
namespace Greg.Xrm.Command.Commands.Column
{
    ...
    public class CreateCommand : ICanProvideUsageExample
    {
        ...
        [Option("type", "at", HelpText = "The type of the attribute.", DefaultValue = SupportedAttributeType.String)]
        public SupportedAttributeType AttributeType { get; set; } = SupportedAttributeType.String;
		...
		public void WriteUsageExamples(MarkdownWriter writer)
		{
			...
			WriteUsageFile(writer);
            WriteUsageImage(writer);
...
pacx column create --type DateTime -t tableName -n columnName --dateTimeBehavior UserLocal --dateTimeFormat DateAndTime", "Powershell");
		...
		private static void WriteUsageFile(MarkdownWriter writer)
		{
			writer.WriteTitle3("File column");
...
", "Powershell");
		...
		private static void WriteUsageImage(MarkdownWriter writer)
		{
			writer.WriteTitle3("Image column");
