...
namespace Greg.Xrm.Command.Commands.Column.Create
{
	...
	public class CreateDoubleCommand : BaseCreateCommand, ICanProvideUsageExample
	{
...
pacx column add double -t tableName -n columnName --precision 4 --min 0 --max 999.99", "Powershell");
		}
	}
}
