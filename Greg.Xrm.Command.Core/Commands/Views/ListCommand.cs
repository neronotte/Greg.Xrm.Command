...
namespace Greg.Xrm.Command.Commands.Views
{
	...
	{
		[Option("table", "t", Order = 1, HelpText = "The table name for which to list the views")]
		[Required]
		public string TableName { get; set; } = string.Empty;


		[Option("type", "q", Order = 2, HelpText = "The type of query to list.", DefaultValue = QueryType.SavedQuery)]
