...
{
    [Command("table", "define-migration-strategy", HelpText = "Builds the data migration strategy to populate all the tables contained in a given solution")]
	[Alias("table", "def-mig")]
	public class TableDefineMigrationStrategyCommand : ICanProvideUsageExample
	{
		...
		public void WriteUsageExamples(MarkdownWriter writer)
		{
			...
			writer.WriteLine("xrm table define-migration-strategy --solution \"my_solution_unique_name\"");
			writer.WriteLine("xrm table def-mig --solution \"my_solution_unique_name\"");
			writer.WriteLine("```");
